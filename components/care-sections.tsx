...
export function CareSections() { return <>
  ...
  <div className="pulse" aria-hidden="true"><svg viewBox="0 0 1200 80" preserveAspectRatio="none"><path className="pulse-base" pathLength={1000} d="M0 40H390L430 40 450 12 474 66 500 23 521 40H1200" /><path className="pulse-run" pathLength={1000} d="M0 40H390L430 40 450 12 474 66 500 23 521 40H1200" /></svg></div>
